...
public interface EmailApi {
	...
	@RequestMapping(value = "/sendEmail", produces = { "application/xml","application/json" }, method = RequestMethod.GET)
	Mono<Boolean> sendEmail();

	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful Operation", response = Email.class),
			@ApiResponse(code = 400, message = "Invalid status value"),
			@ApiResponse(code = 404, message = "Page not found") })
	@RequestMapping(value = "/sendEventEmail/{eventId}", produces = { "application/xml","application/json" }, method = RequestMethod.GET)
