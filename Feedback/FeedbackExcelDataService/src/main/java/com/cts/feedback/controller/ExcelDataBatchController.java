...
import com.cts.feedback.repository.*;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2020-03-15T15:35:34.885+05:30[Asia/Calcutta]")
@Controller
public class ExcelDataBatchController implements ExcelDataBatchApi {

	public static final String EVENT_REPORT = "E:\\Feedback Excel Data\\OutReach_Event_Information.xlsx";
	public static final String EVENT_SUMMARY = "E:\\Feedback Excel Data\\Outreach_Event_Summary.xlsx";
		...
		for (Row row : sheet) {
			...
			if (index != 0) {
				...
				if (usList.block() == null) {
					...
					user.setRole("Poc");
					user.setPassword(passwordEncoder().encode(pocId));
					userList.add(user);
